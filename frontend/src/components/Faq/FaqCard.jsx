...
const FaqCard = ({item}) => {
  ...
  return (
    <div className='p-3 lg:p-5 rounded-[12px] border border-solid border-[#D9DCE2] md-5 cursor-pointer m-9'>
      <div className='flex items-center justify-between gap-7 'onClick={toggleAccordion}>
