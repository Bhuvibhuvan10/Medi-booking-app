        ...
        <div className='w-full max-w-[570px] mx-auto rounded-lg shadow-md md:p-10'>
          ...
          <form className='py-4 md:py-0' onSubmit={submitHandler}>
            <div className='mb-5'>
              ...
              className='w-full py-3 px-4 border-b border-solid border-[#0066ff61] 
            ...
            <div className='mt-7'>
              <button type='submit' className='w-full bg-primaryColor text-white text-[20px] leading-[30px] rounded-lg px-3 py-3'>
